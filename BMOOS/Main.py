...
class DesktopSimulator:
    def __init__(self, root):
        ...
        icon_image_path = os.path.join(script_directory, "IMAGES", "BMOOS LOGO.png")
        ...
        recycle_bin_icon = tk.PhotoImage(file=r_icon_image_path)
    ...
    def on_recycle_bin_click(self):
        ...
        if bmo_talking:
            ...
            self.show_image(t_icon_image_path)
            ...
            self.show_image(I_icon_image_path) 
            # self.bmo_speak("Hello World!")
            self.ask_bmo("HI BMO!")
