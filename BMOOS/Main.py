...
class DesktopSimulator:
    ...
    def on_recycle_bin_click(self):
        ...
        # CHANGE HERE
        if bmo_talking:
            self.show_image("https://media.discordapp.net/attachments/1187870559388840027/1190376979661324348/Talking.png")
            self.ask_bmo("HI BMO!")
        else:
            self.show_image("https://media.discordapp.net/attachments/1187870559388840027/1190376962309505054/Idle.png")
            self.ask_bmo("HI BMO!")
    ...
    def show_image(self, image_path):
        try:
            ...
            resized_image = self.resize_image(image, (480, 320))
